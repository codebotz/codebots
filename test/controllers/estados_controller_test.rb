...
class EstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post estados_url, params: { estado: { contenido: @estado.contenido, likes: @estado.likes } }
    end
  ...
  test "should update estado" do
    patch estado_url(@estado), params: { estado: { contenido: @estado.contenido, likes: @estado.likes } }
